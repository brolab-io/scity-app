...
const PrivateBoxNavbar = ({}) => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-30 flex items-center justify-between h-16 px-4 bg-black border-b border-gray-900 shadow-sm">
      ...
      <div>
        {active ? (
          <div className="relative flex-none group">
            ...
            >
              <div className={clsx(styles.connect, "flex items-center px-5 py-2.5 rounded-full")}>
                <span className="space-x-1 text-sm font-semibold font-poppins">
