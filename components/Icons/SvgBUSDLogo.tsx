...
const SvgBUSDLogo: React.FC<Props> = ({ className }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 336.41 337.42">
      <g id="Layer_2" data-name="Layer 2">
        <g fill="#f0b90b" id="Layer_1-2" data-name="Layer 1">
